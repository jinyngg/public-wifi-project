...
<body>
	...
	<form action="/bookmark/bookmark-group-edit-submit.jsp" method="post" id="bookmarkGroupEdit">
		...
		| <button onclick="bookmarkGroupEdit()">수정</button>
	</form>
